...
document.addEventListener('DOMContentLoaded', () => {
    // *** NOVOS DADOS DE DISCIPLINAS - 7º PERÍODO ***
    const DADOS_DISCIPLINAS_FALTAS = {
        'orto': { percPorFalta: 5.56, nome: 'ORTOPEDIA' }, // 1 falta = -5.56% (18h)
        'oftalmo': { percPorFalta: 1.852, nome: 'OFTALMOLOGIA' }, // 1 falta = -1.852% (54h)
        'cgo': { percPorFalta: 1.087, nome: 'CLÍNICA GINECOLÓGICA E OBSTÉTRICA' }, // 1 falta = -1.087% (92h)
        'cca': { percPorFalta: 0.695, nome: 'CLÍNICA DA CRIANÇA E DO ADOLESCENTE' }, // 1 falta = -0.695% (144h)
        'cm1': { percPorFalta: 0.3475, nome: 'CLÍNICA MÉDICA I' } // 1 falta = -0.3475% (288h)
    };
    // **********************************
